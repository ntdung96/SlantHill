...
//	Helper functions
	...
	//	x and y axes are flipped --> corrected in shader
		...
		Shader.SetGlobalVector(afs_SHAr, vCoeff[0]);
		Shader.SetGlobalVector(afs_SHAg, vCoeff[1]);
		Shader.SetGlobalVector(afs_SHAb, vCoeff[2]);
		...
		Shader.SetGlobalVector(afs_SHBr, vCoeff[0]);
		Shader.SetGlobalVector(afs_SHBg, vCoeff[1]);
		Shader.SetGlobalVector(afs_SHBb, vCoeff[2]);
		...
		Shader.SetGlobalVector(afs_SHC, vCoeff[0]);
